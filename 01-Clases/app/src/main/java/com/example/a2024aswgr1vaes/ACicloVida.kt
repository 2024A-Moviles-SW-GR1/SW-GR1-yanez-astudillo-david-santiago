...
class ACicloVida : AppCompatActivity() {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.run {
            // GUARDAR LAS PRIMITIVAS (GUARDAMOS LAS VARIABLES)
            putString("variableTextoGuardado", textoGlobal) // PutString -> la variable que estamos perdiendo (TextoGlobal) es de tipo string.
        // El nombre de esta variable es la referencia que tenemos para otros métodos.
        }
